...
namespace :gettext do
  ...
  task :setup do
    ...
    require 'hammer_cli_foreman_host_reports/i18n'
    require 'gettext/tools/task'

    domain = HammerCLIForemanHostReports::I18n::LocaleDomain.new
    GetText::Tools::Task.define do |task|
      task.package_name = domain.domain_name
      task.package_version = HammerCLIForemanHostReports.version.to_s
